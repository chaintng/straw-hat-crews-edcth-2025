...
modified: 2025-01-26T02:00:23+07:00
...
<!-- QueryToSerialize: TABLE WITHOUT ID cover, file.link FROM "🏠 Personal/1. Projects/Straw Hat Crews Costume for EDC/Straw Hat Crew Characters" WHERE !contains(tags, "hidden") AND !contains(tags, "folder-note")  sort default(order, 999) ASC -->
<!-- SerializedQuery: TABLE WITHOUT ID cover, file.link FROM "🏠 Personal/1. Projects/Straw Hat Crews Costume for EDC/Straw Hat Crew Characters" WHERE !contains(tags, "hidden") AND !contains(tags, "folder-note")  sort default(order, 999) ASC -->
...
| ![[One_Piece_Live_Action_Character_Posters_04.webp\|One_Piece_Live_Action_Character_Posters_04.webp]]                             | [[Usop 🎯 พลยิง อุซป]]                                 |
...
## Others Characters
![[One Piece Straw Hat Crews Cosplay-3.png]]

![[OnePieceWantedPhotoLarge.jpg]]
![[CqzunvWWcAAqW8Z.jpg-large.jpeg]]